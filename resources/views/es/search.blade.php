...
@section('content')
    ...
    <div class="main__sorting">
        <a href="?search={{ request()->get('search') }}&page={{ request()->get('page') }}{{ request()->has('name') ? (request()->get('name') == 'ascendent' ? '&name=descendent' : '') : '&name=ascendent' }}">
            Nombre
        ...
        <hr>
        <a href="?search={{ request()->get('search') }}&page={{ request()->get('page') }}{{ request()->has('thesis') ? (request()->get('thesis') == 'ascendent' ? '&thesis=descendent' : '') : '&thesis=ascendent' }}">
            Tesis
        ...
        <hr>
        <a href="?search={{ request()->get('search') }}&page={{ request()->get('page') }}{{ request()->has('date') ? (request()->get('date') == 'ascendent' ? '&date=descendent' : '') : '&date=ascendent' }}">
            Fecha
    ...
    <div class="main__pagination">
        ...
        @else
            @if($page - 1 >= 1)
                <a href="?search={{ request()->get('search') }}&page={{ $page - 1 }}{{ 
            ...
            @if($page - 2 > 1)
                <a href="?search={{ request()->get('search') }}&page={{ $page - 2 }}{{ 
                    request()->has('name') ? '&name=' . request()->get('name') : '' 
                }}{{ 
                    request()->has('thesis') ? '&thesis=' . request()->get('thesis') : '' 
                }}{{ 
            ...
            @if($page != $pages)
                <a href="?search={{ request()->get('search') }}&page={{ $pages }}{{ 
                    request()->has('name') ? '&name=' . request()->get('name') : '' 
                }}{{ 
                    request()->has('thesis') ? '&thesis=' . request()->get('thesis') : '' 
                }}{{ 
            ...
            @if($page + 1 <= $pages)
                <a class="flip" href="?search={{ request()->get('search') }}&page={{ $page + 1 }}{{ 
                    request()->has('name') ? '&name=' . request()->get('name') : '' 
                }}{{ 
                    request()->has('thesis') ? '&thesis=' . request()->get('thesis') : '' 
                }}{{ 
